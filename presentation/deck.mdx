...
## Elle a été démocratisé avec le développement d'interface utilisateurs orienté composants.
...
```jsx subtitle="À l'échelle d'un composant, on préfèrerait encapsuler tout son fonctionnement en un fichier"
<Button></Button>
