...
## 👨‍🔬 Nous allons réaliser un [clone de Slack](https://hetic-p2023-react-examples.netlify.com/03-slack/index.html) à partir d'[une intégration front](https://github.com/greeeg/hetic-p2023-react/blob/master/resources/slack/index.html)
